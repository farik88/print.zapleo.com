...
class Coupons extends \common\components\base\BaseActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'hash' => Yii::t('backend_coupons','Код'),
            'value' => Yii::t('backend_coupons','Значение'),
            'discount_type' => Yii::t('backend_coupons','Тип дисконта'),
            'active' => Yii::t('backend_coupons','Статуст'),
            'type' => Yii::t('backend_coupons','Тип'),
        ];
    }
    ...
    {
        return $this->hasMany(\backend\models\CouponCover::className(), ['coupon_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\models\CouponLabel::className(), ['coupon_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\models\Orders::className(), ['coupon_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\models\ProductCoupon::className(), ['coupon_id' => 'id']);
    }

 ...
 *
 * @property \backend\models\OrderProduct[] $orderProducts
 */
class Images extends \common\components\base\BaseActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'title' => Yii::t('backend_images','Название'),
            'name' => Yii::t('backend_images','Имя файла'),
            'ext' => Yii::t('backend_images','Расширение'),
        ];
    }
    ...
    {
        return $this->hasMany(\backend\models\OrderCart::className(), ['image_id' => 'id']);
    }

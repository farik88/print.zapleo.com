...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'label_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\backend\models\Labels::find()->orderBy('id')->asArray()->all(), 'id', 'name'),
            ],
        ],
        'del' => [
            'type' => 'raw',
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowCouponLabel(' . $key . '); return false;', 'id' => 'coupon-label-del-btn']);
            },
        ],
    ],
    'gridSettings' => [

 ...
 *
 * @property \common\models\AccessUser[] $accessUsers
 */
class Accesses extends \common\components\base\BaseActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'title' => Yii::t('frontend_accesses','Название'),
            'value' => Yii::t('frontend_accesses','Значение'),
        ];
    }
    ...
    {
        return $this->hasMany(\common\models\AccessUser::className(), ['access_id' => 'id']);
    }

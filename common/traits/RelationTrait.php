                                ...
                                if (!$isNewRecord) {
                                    ...
                                    if ($isManyMany) {
                                        ...
                                        try {
                                            ...
                                            $this->addError($name, "Данные не могут быть удалены, так как он по-прежнему используется другими данными.");
                                            $error = true;
                                        }
                                    } else {
                                        ...
                                        if (!empty($compiledNotDeletedPK)) {
                                            try {
                                                ...
                                                $this->addError($name,  "Данные не могут быть удалены, поскольку он по-прежнему используется другими данными.");
                                                $error = true;
                                            }
                                        }
                                    }
                    ...
                    if (empty($relData[$relName]['via'])) {
                        ...
                        if ($isManyMany) {
                            ...
                            try {
                                ...
                                $this->addError($relData[$relName]['name'], "Данные не могут быть удалены, поскольку они по-прежнему используется другими данными.");
                                $error = true;
                            }
                        } else {
                            if ($relData[$relName]['ismultiple']) {
                                ...
                                try {
                                    ...
                                    $this->addError($relData[$relName]['name'], "Данные не могут быть удалены, поскольку он по-прежнему используется другими данными.");
                                    $error = true;
                                }
                            }
                        }
